...
<template>
	...
	<span class="root-url">{{url}}</span
		><span class="subdirectory-url">/{{subdirectory}}/</span
			...
			><input type="text" name="slug" class="form-control-sm" v-show="isEditing" v-model="customSlug"/>
	</div>

	<div class="button-wrapper wrapper">
		<button class="btn btn-light btn-sm save-slug-button" v-show="!isEditing" @click.prevent="editSlug">Edit</button>
